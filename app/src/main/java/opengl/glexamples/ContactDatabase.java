...
//        try {
//            sld= SQLiteDatabase.openDatabase("/data/data/opengl.glexamples/mydb",
//                    null,
...
//        try {
//            //String sql="insert into contact('id','name','phone','email','group','DATA1','DATA2','DATA3','DATA4','DATA5') values (?,?,?,?,'1',null,null,null,null,null)";
//            String sql="insert into contact('id','name','phone','email','group','style') " +
//                    "values (?,?,?,?,?,?)";
//            sld.execSQL(sql, new String[]{id, name, phone,email,"1","0"});
//
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
